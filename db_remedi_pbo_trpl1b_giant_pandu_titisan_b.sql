...
--
-- Host: localhost:3306
-- Generation Time: Jul 14, 2026 at 03:13 AM
...
--
-- Table structure for table `db_remedi_pbo_trpl1b_giant_pandu_titisan_b`
--

CREATE TABLE `db_remedi_pbo_trpl1b_giant_pandu_titisan_b` (
...
--
-- Dumping data for table `db_remedi_pbo_trpl1b_giant_pandu_titisan_b`
--

INSERT INTO `db_remedi_pbo_trpl1b_giant_pandu_titisan_b` (`id_reservasi`, `nama_pelanggan`, `tanggal_booking`, `durasi_jam`, `tarif_dasar_per_jam`, `jenis_paket`, `tipe_background`, `cetak_foto_lembar`, `kuota_talent_orang`, `layanan_makeup`, `nama_lokasi_luar`, `biaya_transportasi_tim`) VALUES
...
--
-- Indexes for table `db_remedi_pbo_trpl1b_giant_pandu_titisan_b`
--
ALTER TABLE `db_remedi_pbo_trpl1b_giant_pandu_titisan_b`
...
--
-- AUTO_INCREMENT for table `db_remedi_pbo_trpl1b_giant_pandu_titisan_b`
--
ALTER TABLE `db_remedi_pbo_trpl1b_giant_pandu_titisan_b`
